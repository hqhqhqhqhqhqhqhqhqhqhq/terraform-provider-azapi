...
type ManagementGroupScopeResourceIdFunction struct{}

func (m *ManagementGroupScopeResourceIdFunction) Metadata(ctx context.Context, request function.MetadataRequest, response *function.MetadataResponse) {
	response.Name = "build_management_group_scope_resource_id"
}

func (m *ManagementGroupScopeResourceIdFunction) Definition(ctx context.Context, request function.DefinitionRequest, response *function.DefinitionResponse) {
...
func (m *ManagementGroupScopeResourceIdFunction) Run(ctx context.Context, request function.RunRequest, response *function.RunResponse) {
...
var _ function.Function = &ManagementGroupScopeResourceIdFunction{}
