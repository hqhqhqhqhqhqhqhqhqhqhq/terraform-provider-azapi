...
type ResourceGroupScopeResourceIdFunction struct{}

func (r *ResourceGroupScopeResourceIdFunction) Metadata(ctx context.Context, request function.MetadataRequest, response *function.MetadataResponse) {
	response.Name = "build_resource_group_scope_resource_id"
}

func (r *ResourceGroupScopeResourceIdFunction) Definition(ctx context.Context, request function.DefinitionRequest, response *function.DefinitionResponse) {
...
func (r *ResourceGroupScopeResourceIdFunction) Run(ctx context.Context, request function.RunRequest, response *function.RunResponse) {
...
var _ function.Function = &ResourceGroupScopeResourceIdFunction{}
